...
// 실무에서는 반복문 사용하시길 권해드립니다. 알고리즘 문제에서는 간혹 재귀를 호출해야 할 일이 있습니다. 
...
function factorial(n) {
  ...
  // else를 쓸필요가 없다.  // early return
  return n * factorial(n-1)   // 내(factorial)가 나(factorial)를 호출한다.
}

//               return              최종값
factorial(5)  5 * factorial(4)    5 * 24 == 120
factorial(4)  4 * factorial(3)    4 * 6 == 24
factorial(3)  4 * factorial(2)    3 * 2 == 6
factorial(2)  2 * factorial(1)    2 * 1 == 2
factorial(1)  1

// 누적합(이렇게 일일이 순회하지 않고 구할 수 있는 값이기 때문에 2개 다 비효율적인 코드입니다. 특히 소수 구하는 문제 같은 2중 for문 사용하는 것도 매우 비효율적입니다.)
result = 0
...
// txt                return(내려갔다가)             최종값(다시 올라오기)
reverse('hello')     reverse('ello') + 'h'        'olle' + 'h' == 'elleh'
reverse('ello')      reverse('ello') + 'e'        'oll' + 'e' == 'olle'
