...
console.log(a)  // 100 (var는 함수 스코프이기때문)
console.log(b)  // 결과 x (블록레벨)
console.log(c)  // 결과 x (블록레벨)
...
const 함수 = function (x) {    // let과 const는 선언한 다음부터 할당이 가능하다. 
  return x + 100
}
...
let foo = 1;
  {
      ...
      console.log(foo);
      let foo = 2;
  }  // error  // let과 const는 선언한 다음부터 할당이 가능하다. 