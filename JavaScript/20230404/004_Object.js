...
// 유사배열 객체는 실무에서도 사용하지 않기 때문에 잊으셔도 됩니다. 
const arr = {
  0: 10,
  1: 20,
  2: 30,
...
// 다른 언어와 동작 방식이 달라 주의해주세요. 
console.log('age' in human);  // true
// console.log(20 in [10, 20, 30, 40]);  // false  // in 연산자가 키만을 순회해서
...
// 별표(***)
// 다른언어는 aespa.keys()와 같은 방식으로 사용합니다. 
console.log(Object.keys(aespa));   // 불편한 코드입니다. ['members', 'from', 'sing']
